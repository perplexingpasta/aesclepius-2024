...
//     // Clean up event listener on unmount or when overlay is closed
//     return () => {
...
//               </button>
//             </div> */}
//             <div className="4buttondiv flex flex-col items-start justify-start space-y-4">
//               <Link
...
//               </Link>
//             </div>
//             <div className="notediv mt-10 max-w-[75vw] items-start justify-start font-lexendDeca text-sm font-light text-white opacity-50 md:mt-16 md:max-w-[65vw] md:text-base">
  ...
  return (
    ...
    >
      ...
      <div className="my-5 flex flex-col items-center justify-center space-y-6 md:my-10 md:flex-row md:space-x-4 md:space-y-0">
        ...
        <Link
          ref={button2Ref}
          href="https://drive.google.com/file/d/1ZsZKvF4BJmjvXJbsENJ_8gdrLvutc_c1/view?usp=sharing"
          target="_blank"
        >
          <LitUpButton
            title="View Brochure"
